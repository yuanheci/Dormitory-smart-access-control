...
//指纹模块初始化引脚定义     //PC13
#define PS_STA_PORT_CLK      RCC_APB2Periph_GPIOC
#define PS_STA_PORT			 GPIOC
#define PS_STA_PORT_PIN  	 GPIO_Pin_13


#define PS_Sta   PCin(13)//读指纹模块状态引脚    触摸端感应到时输出高电平
...
void PS_StaGPIO_Init(void);       //PC13
